            ...
            <div class="col-md-2 bg-light d-none d-md-block sidebar">
                <div class="left-sidebar">
                    <ul class="nav flex-column sidebar-nav">
                        <li class="nav-item">
                            <a style="margin-left:0.3cm" class="nav-link active" href="{{url('dashboard2')}}">
                        ...
                        <li class="nav-item">
                            <a style="margin-left:0.7cm" class="nav-link" href="{{url('profile2')}}">
                                <svg class="bi bi-chevron-right" width="16" height="16" viewBox="0 0 20 20"
                                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                                        d="M6.646 3.646a.5.5 0 01.708 0l6 6a.5.5 0 010 .708l-6 6a.5.5 0 01-.708-.708L12.293 10 6.646 4.354a.5.5 0 010-.708z"
                                        clip-rule="evenodd" /></svg>
                                        <label style="font-size:22px;"> <u>Profile</u></label>
                            </a>
                        </li>
...
<tr>
  ...
  <tr><th>Phone</td><td>{{$user->Phone}}</th>
</tr>
@endforeach
    </tbody>
</table>
